...
import PhoneCallWarningDialogComponent from '../PhoneCallWarningDialogComponent';

describe('PhoneCallWarningDialogComponent', () => {
  let isDialogOpen;
  let handleCancel;
  let handleClose;
  let handleIgnore;
  ...
  const setup = () => shallow(<PhoneCallWarningDialogComponent

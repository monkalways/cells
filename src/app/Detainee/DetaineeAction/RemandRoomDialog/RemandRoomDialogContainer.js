...
export const mapStateToProps = (
  ...
  destinationRoom = selectors.getFirstAvailableRemandRoomState(state),
  isAnyRoomAvailable = selectors.isRemandRoomOptionAvailableState(state),
...
export const mapDispatchToProps = (dispatch) => ({
  ...
  getAvailableRoomsRefresh: (getAvailableRoomsRefresh = operations.getAvailableRemandRoomsRefresh) => {
